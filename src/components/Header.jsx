...
import { Banner1, Banner2, Banner3, Banner4, Banner5, Banner6,Banner7  } from "../images/index";
  ...
  return (
    ...
    <div className="w-full h-[100vh]">
      ...
      className="absolute w-full h-full bg-gradient-to-t from-black to-transparent top-0 z-8 flex flex-col items-center justify-center pt-40 2xl:pt-20 px-4">
        ...
        {
            type && (
                <p className="text-sm mt-4 text-center text-green-500 bg-[#00000090] px-6 py-4 rounded-full">Welcome to Taste Track, your passport to culinary adventures!<br className="hidden md:block" />
